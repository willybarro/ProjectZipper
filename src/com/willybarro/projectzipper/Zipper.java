...
public class Zipper {
            ...
            throws Exception
    {
        try {
            ...
            if(destination.exists()) {
                String dirFile = destination.isFile() ? "file location" : "firectory";
    ...
    private Document buildAntDocument(boolean isZip)
    {
        try {
            ...
            root.setAttribute("name", ProjectHelper.getMainProjectName());
            root.setAttribute("default", "do-export");
            root.setAttribute("basedir", ProjectHelper.getMainProjectAbsolutePath());
    ...
    {
        String mainAbsolutePath = ProjectHelper.getMainProjectAbsolutePath();
        Document doc = root.getOwnerDocument();
        ...
        for(TreePath c : checkedPaths) {
            ...
            includePattern = p.getAbsolutePath().replace(mainAbsolutePath, "");
        ...
        fileset.setAttribute("dir", mainAbsolutePath);
